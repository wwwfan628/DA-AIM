...
class VideoVisualizer:
    ...
    def draw_clip(
        ...
        # Luca Sieber: The following lines must be activated in hotfix mode
        hotfix = True
        ...
        if not hotfix:
            ...
            task_id = torch.load('/home/yiflu/Desktop/domain-adaptive-slowfast/slowfast/hotfix/counter.pt').item()
            print('printing the counter', str(task_id))
            print('half_left', half_left)
            print('half_right', half_right)
            # torch.load('/home/yiflu/Desktop/domain-adaptive-slowfast/slowfast/hotfix/' + str(self.id) + '_boxes.pt')
            import os
            print('path exists:',
                  os.path.isfile('/home/yiflu/Desktop/domain-adaptive-slowfast/slowfast/hotfix/' + str(task_id) + '_boxes.pt'))
            ...
            not_last = os.path.isfile('/home/yiflu/Desktop/domain-adaptive-slowfast/slowfast/hotfix/' + str(task_id + 1) +
                                      '_boxes.pt')

            # load the bounding boxes of next task else set counter in file system to zero and remove all the boxes
            if not_last:
                bboxes_next = torch.load('/home/yiflu/Desktop/domain-adaptive-slowfast/slowfast/hotfix/' + str(task_id + 1) +
                                         '_boxes.pt')
                ...
                bboxes_prev = torch.load('/home/yiflu/Desktop/domain-adaptive-slowfast/slowfast/hotfix/' + str(task_id - 1) +
                                         '_boxes.pt')
                ...
                # torch.save(torch.tensor(0), '/home/yiflu/Desktop/domain-adaptive-slowfast/slowfast/hotfix/counter.pt')
                for i in range(task_id + 1):
                    os.remove('/home/yiflu/Desktop/domain-adaptive-slowfast/slowfast/hotfix/' + str(i) +
                              '_boxes.pt')
                    print('lol')

            # increase the task id by one
            torch.save(torch.tensor(task_id + 1), '/home/yiflu/Desktop/domain-adaptive-slowfast/slowfast/hotfix/counter.pt')
