...
_C.GRL.PLACE_ADV = ['Y', 'Y', 'N', 'Y']
_C.GRL.USE_ATTN = 'TransAttn'
_C.GRL.USE_ATTN_FRAME = 'TransAttn'
_C.GRL.ENTROPY = True
_C.GRL.ADD_FC = 1
_C.GRL.SHARE_PARAMS = 'Y'
_C.GRL.BETA = [0.75, 0.75, 0.5]
_C.GRL.DROP_OUT_I = 0.5
_C.GRL.DROP_OUT_V = 0.5
_C.GRL.FEAT_SHARED_DIM = 512

_C.DA = CfgNode()
_C.DA.TRAIN_ENABLE = False
...
_C.AUX.CLASSES = 0
_C.AUX.DATASET = "Auxava"
_C.AUX.AUX_TYPE = "rotation"      # rotation | clip_order | none
_C.AUX.FRAME_DIR = "/srv/beegfs02/scratch/da_action/data/kinetics700/frames/"
_C.AUX.LABEL_MAP_FILE = "ava_action_list_v2.2.pbtxt"
_C.AUX.FRAME_LIST_DIR = "/srv/beegfs02/scratch/da_action/data/kinetics700/frame_lists_10_5_2/"
_C.AUX.ANNOTATION_DIR = "/srv/beegfs02/scratch/da_action/data/kinetics700/annotations_10_5_2/"
_C.AUX.TRAIN_LISTS = ["train.csv"]
_C.AUX.TEST_LISTS = ["val.csv"]
_C.AUX.EXCLUSION_FILE = "kinetics_val_excluded_timestamps_v2.1.csv"
_C.AUX.DETECTION_SCORE_THRESH = 0.1
_C.AUX.TRAIN_GT_BOX_LISTS = []
_C.AUX.TEST_GT_BOX_LISTS = []
_C.AUX.TRAIN_PREDICT_BOX_LISTS = ["kinetics_train_predicted_boxes.csv"]
_C.AUX.TEST_PREDICT_BOX_LISTS = ["kinetics_val_predicted_boxes.csv"]
_C.AUX.GROUNDTRUTH_FILE = "kinetics_val_v2.1.csv"
_C.AUX.FULL_TEST_ON_VAL = True
# _C.AUX.WEIGHT_MAIN = 0.5 # ignore (not used anymore)
# _C.AUX.WEIGHT_AUX = 0.5 # ignore (not used anymore)
_C.AUX.LOSS_FACTOR = 10.0
_C.AUX.F_CONFUSION = -1
...
_C.TENSORBOARD.TSNE.ENABLE = False
_C.TENSORBOARD.TSNE.FEATURE_FILE_NAME = ""
_C.TENSORBOARD.TSNE.LABEL_FILE_NAME = ""
