...
class ObjectDetectionEvaluation(object):
    ...
    """
        ...
        for class_index in range(self.num_class):
            ...
            precision, recall, threshold = metrics.compute_precision_recall(
                scores,
                tp_fp_labels,
            ...
            self.thresholds_per_class.append(threshold)
        ...
        # print('object_detection_evaluation.py line 818')
        # print('self.precisions_per_class: ', self.precisions_per_class)
        # print('self.precisions_per_class length: ', len(self.precisions_per_class))
        # print('self.precisions_per_class[0] shape: ', self.precisions_per_class[0].shape)
        # print('self.recalls_per_class: ', self.recalls_per_class)
        # print('self.recalls_per_class length: ', len(self.recalls_per_class))
        # print('self.recalls_per_class[0] shape: ', self.recalls_per_class[0].shape)
