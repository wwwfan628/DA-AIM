...
COUT_DIR=/cluster/work/cvl/susaha/experiments/experiments_yifan/kincad22cad1_dacs_cm/

###################################################
init_method="tcp://localhost:2022"

CFG_FILE=configs/Gurkirt_and_Suman/KINCAD22CAD1/SLOWFAST_32x2_R50_DA_DACS_PLOT_CM.yaml
