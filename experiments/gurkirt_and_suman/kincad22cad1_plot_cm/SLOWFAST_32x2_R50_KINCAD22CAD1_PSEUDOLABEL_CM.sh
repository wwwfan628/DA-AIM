...
COUT_DIR=/cluster/work/cvl/susaha/experiments/experiments_yifan/kincad22cad1_pseudolabel_cm/

###################################################
init_method="tcp://localhost:2023"

CFG_FILE=configs/Gurkirt_and_Suman/KINCAD22CAD1/SLOWFAST_32x2_R50_DA_PSEUDOLABEL_PLOT_CM.yaml
