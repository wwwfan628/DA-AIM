...
COUT_DIR=/cluster/work/cvl/susaha/experiments/experiments_yifan/kin2as_baseline_lr0.025/

###################################################
init_method="tcp://localhost:9991"
...
python tools/run_net.py --cfg ${CFG_FILE} \
        ...
        AVA.FRAME_LIST_DIR "/cluster/work/cvl/susaha/dataset/action-dataset/datasets_yifan/kinetics_3_5000_all/frame_lists/" \
        AVA.ANNOTATION_DIR "/cluster/work/cvl/susaha/dataset/action-dataset/datasets_yifan/kinetics_3_5000_all/annotations/" \
        MODEL.NUM_CLASSES 3 \
        TRAIN.BATCH_SIZE 24 \
