...
COUT_DIR=/cluster/work/cvl/susaha/experiments/experiments_yifan/kin2as_cliporder_lr0.025/

###################################################
init_method="tcp://localhost:2001"

CFG_FILE=configs/Gurkirt_and_Suman/KIN2ARMASUISSE/SLOWFAST_32x2_R50_DA_ClipOrder.yaml
