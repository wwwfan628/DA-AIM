...
COUT_DIR=/cluster/work/cvl/susaha/experiments/experiments_yifan/kin2ava_rotation_lr0.01/

###################################################
init_method="tcp://localhost:1992"

CFG_FILE=configs/Gurkirt_and_Suman/KIN2AVA/SLOWFAST_32x2_R50_DA_Rotation.yaml
