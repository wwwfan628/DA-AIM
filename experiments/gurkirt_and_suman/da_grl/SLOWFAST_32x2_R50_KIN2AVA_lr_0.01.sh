...
COUT_DIR=/cluster/work/cvl/susaha/experiments/experiments_yifan/kin2ava_grl_lr0.01/

###################################################
init_method="tcp://localhost:4336"

CFG_FILE=configs/Gurkirt_and_Suman/KIN2AVA/SLOWFAST_32x2_R50_DA_GRL.yaml
