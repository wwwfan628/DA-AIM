...
COUT_DIR=/cluster/work/cvl/susaha/experiments/experiments_yifan/kin2ava_classmix_resize_lr0.025/

###################################################
init_method="tcp://localhost:5005"
...
python tools/run_net.py --cfg ${CFG_FILE} \
        ...
        DACS.PSEUDO_LABEL_ENABLE False \
