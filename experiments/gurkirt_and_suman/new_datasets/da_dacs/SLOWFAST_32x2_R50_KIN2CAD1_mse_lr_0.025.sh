...
COUT_DIR=/cluster/work/cvl/susaha/experiments/experiments_yifan/kin2cad1_daaim_mse_lr0.025/

###################################################
init_method="tcp://localhost:9014"

CFG_FILE=configs/Gurkirt_and_Suman/KIN2CAD1/SLOWFAST_32x2_R50_DA_DACS.yaml
...
now=$(date +"%T")
echo "time after DA training to CAD1 with Kinetics Source: $now"
echo ${COUT_DIR}
...
now=$(date +"%T")
echo "time after testing DA to CAD1 Supervised Kinetics on CAD1: $now"
echo ${COUT_DIR}
