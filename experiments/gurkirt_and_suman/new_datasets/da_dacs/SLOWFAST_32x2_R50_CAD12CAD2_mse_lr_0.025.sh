...
COUT_DIR=/cluster/work/cvl/susaha/experiments/experiments_yifan/cad12cad2_daaim_mse_lr0.025/

###################################################
init_method="tcp://localhost:4479"

CFG_FILE=configs/Gurkirt_and_Suman/CAD12CAD2/SLOWFAST_32x2_R50_DA_DACS.yaml
...
now=$(date +"%T")
echo "time after DA training to CAD2 with CAD1 Source: $now"
echo ${COUT_DIR}
...
now=$(date +"%T")
echo "time after testing DA to CAD2 Supervised CAD1 on CAD2: $now"
echo ${COUT_DIR}
