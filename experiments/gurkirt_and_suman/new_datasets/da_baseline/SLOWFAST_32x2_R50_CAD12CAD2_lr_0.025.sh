...
COUT_DIR=/cluster/work/cvl/susaha/experiments/experiments_yifan/cad12cad2_baseline_lr0.025/

###################################################
init_method="tcp://localhost:1512"

CFG_FILE=configs/Gurkirt_and_Suman/CAD1/SLOWFAST_32x2_R50_ALL.yaml
