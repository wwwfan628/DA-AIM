...
COUT_DIR=/cluster/work/cvl/susaha/experiments/experiments_yifan/kin2as_dacs+aim_mse_resize_lr0.05/

###################################################
init_method="tcp://localhost:6001"
