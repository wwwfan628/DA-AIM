...
###################################################
## TODO: should be different for every experiment
COUT_DIR=/cluster/work/cvl/susaha/experiments/experiments_yifan/kin2ava_dacs+aim_resize_lr0.025/
###################################################
init_method="tcp://localhost:6005"
