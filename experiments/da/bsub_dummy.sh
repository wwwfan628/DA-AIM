...
### Training 
COUT_DIR=/cluster/work/cvl/gusingh/data/ava-kinetics/kinetics/experiments/dummy/
CFG_FILE=configs/AVA-KIN/KIN/SLOWFAST_32x2_R50_YOLO_DA1.yaml
python tools/run_net.py --cfg ${CFG_FILE} AVA.FRAME_DIR ${TARGET_DIR} AUX.FRAME_DIR ${TARGET_DIR}  AUX.LOSS_FACTOR ${LOSS_FACTOR} AVA.DETECTION_SCORE_THRESH ${TRAIN_THRESH} OUTPUT_DIR ${COUT_DIR} NUM_GPUS 1 TRAIN.BATCH_SIZE 2
now=$(date +"%T")
