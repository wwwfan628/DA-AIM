...
# SOURCE_DIR=/cluster/work/cvl/gusingh/data/ava-kinetics/ava/cgan-val-tarballs/
# time python unpack_dataset.py ${TARGET_DIR} ${SOURCE_DIR} --num_jobs=16
# now=$(date +"%T")
...
# SOURCE_DIR=/cluster/work/cvl/gusingh/data/ava-kinetics/kinetics/cgan-train-tarballs/
time python unpack_dataset.py ${TARGET_DIR} ${SOURCE_DIR} --num_jobs=16
now=$(date +"%T")
...
SOURCE_DIR=/cluster/work/cvl/gusingh/data/ava-kinetics/kinetics/cgan-val-tarballs/
time python unpack_dataset.py ${TARGET_DIR} ${SOURCE_DIR} --num_jobs=16
now=$(date +"%T")
