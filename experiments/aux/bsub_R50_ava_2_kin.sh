...
echo ${TARGET_DIR}
COUT_DIR=/cluster/work/cvl/gusingh/data/ava-kinetics/ava/experiments/SLOWFAST_32x2_R50_MIT_YOLO_AUX_KIN_ROT/
...
COUT_DIR=/cluster/work/cvl/gusingh/data/ava-kinetics/ava/experiments/SLOWFAST_32x2_R50_MIT_YOLO_AUX_KIN_ROT_SUP_AVA_RETRY/
