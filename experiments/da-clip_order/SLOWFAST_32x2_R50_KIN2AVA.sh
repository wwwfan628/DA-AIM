...
TRAIN_THRESH=0.8
EVAL_THRESH=0.8
COUT_DIR=/cluster/work/cvl/susaha/experiments/experiments_yifan/kin2ava_cliporder/
init_method="tcp://localhost:2003"

# Training
echo "#################### Training on KIN #####################"
CFG_FILE=configs/DA-AIM/KIN2AVA/SLOWFAST_32x2_R50_DA_ClipOrder.yaml
