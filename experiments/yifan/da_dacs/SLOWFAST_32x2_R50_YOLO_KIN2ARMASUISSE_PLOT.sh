...
#SBATCH --output=/home/yiflu/Desktop/experiments/KIN2ARMASUISSE_PLOT/%j.out                 # where to store the output ( %j is the JOBID )
#SBATCH --error=/home/yiflu/Desktop/experiments/KIN2ARMASUISSE_PLOT/%j.err                  # where to store error messages
#SBATCH --gres=gpu:2
...
cd ../../..
COUT_DIR=/home/yiflu/Desktop/experiments/KIN2ARMASUISSE_PLOT/
CFG_FILE=configs/Yifan/KIN2ARMASUISSE/SLOWFAST_32x2_R50_YOLO_DA_DACS_PLOT.yaml
