...
#SBATCH --output=/home/yiflu/Desktop/experiments/AVA2KIN/%j.out                 # where to store the output ( %j is the JOBID )
#SBATCH --error=/home/yiflu/Desktop/experiments/AVA2KIN/%j.err                  # where to store error messages
#SBATCH --gres=gpu:4
...
cd ../../..
COUT_DIR=/home/yiflu/Desktop/experiments/AVA2KIN/
CFG_FILE=configs/Yifan/AVA2KIN/SLOWFAST_32x2_R50_YOLO_DA_DACS_SINGLE_FRAME.yaml
