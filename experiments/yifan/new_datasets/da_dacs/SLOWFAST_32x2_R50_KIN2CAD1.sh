...
#SBATCH --output=/home/yiflu/Desktop/experiments/KIN2CAD1/%j.out                 # where to store the output ( %j is the JOBID )
#SBATCH --error=/home/yiflu/Desktop/experiments/KIN2CAD1/%j.err                  # where to store error messages
#SBATCH --gres=gpu:4
...
cd ../../../..
COUT_DIR=/home/yiflu/Desktop/experiments/KIN2CAD1/
CFG_FILE=configs/Yifan/KIN2CAD1/SLOWFAST_32x2_R50_DA_DACS.yaml
