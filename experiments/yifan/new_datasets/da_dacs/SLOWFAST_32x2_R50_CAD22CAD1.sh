...
#SBATCH --output=/home/yiflu/Desktop/experiments/CAD22CAD1/%j.out                 # where to store the output ( %j is the JOBID )
#SBATCH --error=/home/yiflu/Desktop/experiments/CAD22CAD1/%j.err                  # where to store error messages
#SBATCH --gres=gpu:4
...
cd ../../../..
COUT_DIR=/home/yiflu/Desktop/experiments/CAD22CAD1/
CFG_FILE=configs/Yifan/CAD22CAD1/SLOWFAST_32x2_R50_DA_DACS.yaml
