...
#SBATCH --output=/home/yiflu/Desktop/experiments/CAD1/%j.out                 # where to store the output ( %j is the JOBID )
#SBATCH --error=/home/yiflu/Desktop/experiments/CAD1/%j.err                  # where to store error messages
#SBATCH --gres=gpu:4
...
cd ../../../..
COUT_DIR=/home/yiflu/Desktop/experiments/CAD1/
...
now=$(date +"%T")
echo "time after training with CAD1: $now"