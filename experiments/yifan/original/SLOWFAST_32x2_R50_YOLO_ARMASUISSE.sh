...
#SBATCH --output=/home/yiflu/Desktop/experiments/ARMASUISSE/%j.out                 # where to store the output ( %j is the JOBID )
#SBATCH --error=/home/yiflu/Desktop/experiments/ARMASUISSE/%j.err                  # where to store error messages
#SBATCH --gres=gpu:2
...
cd ../../..
COUT_DIR=/home/yiflu/Desktop/experiments/ARMASUISSE/
...
now=$(date +"%T")
echo "time after training with ARMASUISSE: $now"