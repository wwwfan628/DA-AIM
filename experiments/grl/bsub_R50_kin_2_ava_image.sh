...
init_method="tcp://localhost:9904"
### Training 
COUT_DIR=/cluster/work/cvl/gusingh/data/ava-kinetics/kinetics/experiments/SLOWFAST_32x2_R50_MIT_YOLO_GRL_IMG_001_wGT/
...
python tools/run_net.py --cfg ${CFG_FILE} --init_method ${init_method} \
        ...
        OUTPUT_DIR ${COUT_DIR}  GRL.TYPE 'image' GRL.LAMBDA ${GRL_LAMBDA} \
